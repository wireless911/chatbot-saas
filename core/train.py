...
"""
=================================================
@Project -> File   ：chatbot-saas -> train
@IDE    ：PyCharm
@Author ：Mr. Wireless
...
async def _train_async_internal(
    ...
    if stories.is_empty():
        _logger.warning("No stories present. Just a Rasa NLU model will be trained.")
    ...
    if nlu_data.is_empty():
        _logger.warning("No NLU data present. Just a Rasa Core model will be trained.")
